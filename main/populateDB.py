...
from main.scrapping import (
    raw_nutrition_scrapping,
    hsn_store_scrapping,
    big_supplementation_scrapping,
    prozis_scrapping,
)
import time
...
def populate():
    ...
    print(
        "Se han cargado " + str(ix.searcher().doc_count()) + " descripciones y reviews"
    )
